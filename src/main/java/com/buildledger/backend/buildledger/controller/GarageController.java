...
import com.buildledger.backend.buildledger.service.impl.building.GarageService;
...
public class GarageController {
    ...
    public ResponseEntity<ResponseGarageDTO> updateGarage(@Valid @RequestBody UpdateGarageDTO updateGarageDTO) {
        System.out.println("Updating garage" + updateGarageDTO.getId() + " " + updateGarageDTO.getFloorID() + " " + updateGarageDTO.getPriceEur());
